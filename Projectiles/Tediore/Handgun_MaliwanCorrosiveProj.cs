...
{
	public class Handgun_MaliwanCorrosiveProj : ModProjectile
	{		
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				int num624 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 163, 0f, 0f, 100, default(Color), 3f);
				Main.dust[num624].noGravity = true;
				Main.dust[num624].velocity *= 1.5f;
                Main.dust[num624].scale = .6f;
                Main.dust[num624].noLight = true;
				num624 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 163, 0f, 0f, 100, default(Color), 2f);
