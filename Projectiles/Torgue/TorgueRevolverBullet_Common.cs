...
{
	public class TorgueRevolverBullet_Common : ModProjectile
	{		
		...
		{
Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("TorgueExplosion"), projectile.damage/3, projectile.knockBack, projectile.owner, 0f, 0f);
