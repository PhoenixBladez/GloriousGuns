...
{
	public class TMP_MaliwanSlag : ModItem
	{
		...
		public string WeaponName => "Slag " + RandNames[nameIndex%RandNames.Length]+" TMP";
		...
		public override void SetStaticDefaults()
		{
            ...
            GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Vladof/TMP_MaliwanSlagGlow");
		}
		...
		{
			var myClone = (TMP_MaliwanSlag)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Vladof/TMP_MaliwanSlagGlow"),
				new Vector2
				(
