...
{
	public class TMP_MaliwanShock : ModItem
	{
		...
		public string WeaponName => "Discharge " + RandNames[nameIndex%RandNames.Length]+" TMP";
		...
		{
			var myClone = (TMP_MaliwanShock)base.Clone(itemClone);
