...
{
	public class TMP_MaliwanCorrosive : ModItem
	{
		...
		public string WeaponName => "Caustic " + RandNames[nameIndex%RandNames.Length]+" TMP";
		...
		public override void SetStaticDefaults()
		{
            ...
            GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Vladof/TMP_MaliwanCorrosiveGlow");
		}
		...
		{
			var myClone = (TMP_MaliwanCorrosive)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Vladof/TMP_MaliwanCorrosiveGlow"),
				new Vector2
				(
