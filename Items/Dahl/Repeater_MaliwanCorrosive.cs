...
{
	public class Repeater_MaliwanCorrosive : ModItem
	{
		...
		public string WeaponName => "Corrosive " + RandNames[nameIndex%RandNames.Length]+" Repeater";
		...
		public override void SetStaticDefaults()
		{
            ...
            GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Dahl/Repeater_MaliwanCorrosiveGlow");
		}
		...
		{
			var myClone = (Repeater_MaliwanCorrosive)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Dahl/Repeater_MaliwanCorrosiveGlow"),
				new Vector2
				(
		...
		{
			Lighting.AddLight(item.position,0.2f, 0.4f, 0.06f);
			Texture2D texture;
            texture = Main.itemTexture[item.type];
		...
		public void Generate()
		{
			...
			item.value = new UnifiedRandom().Next(200, 800);
