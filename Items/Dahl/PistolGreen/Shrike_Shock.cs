...
namespace GloriousGuns.Items.Dahl.PistolGreen
{
	public class Shrike_Shock : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Dahl/PistolGreen/Shrike_ShockGlow");
		}
		...
		{
			var myClone = (Shrike_Shock)base.Clone(itemClone);
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Dahl/PistolGreen/Shrike_ShockGlow"),
				new Vector2
				(
