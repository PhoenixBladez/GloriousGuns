...
namespace GloriousGuns.Items.Dahl.PistolGreen
{
	public class Shrike_Slag : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Dahl/PistolGreen/Shrike_SlagGlow");
		}
		...
		{
			var myClone = (Shrike_Slag)base.Clone(itemClone);
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Dahl/PistolGreen/Shrike_SlagGlow"),
				new Vector2
				(
