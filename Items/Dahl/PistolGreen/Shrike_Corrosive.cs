...
namespace GloriousGuns.Items.Dahl.PistolGreen
{
	public class Shrike_Corrosive : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
            ...
            GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Dahl/PistolGreen/Shrike_CorrosiveGlow");
		...
		{
			var myClone = (Shrike_Corrosive)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Dahl/PistolGreen/Shrike_CorrosiveGlow"),
				new Vector2
				(
