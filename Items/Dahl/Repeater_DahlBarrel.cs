...
{
	public class Repeater_DahlBarrel : ModItem
	{
		...
		public string WeaponName => RandNames[nameIndex%RandNames.Length]+" Repeater";
		...
		{
			var myClone = (Repeater_DahlBarrel)base.Clone(itemClone);
		...
		{
			Vector2 muzzleOffset = Vector2.Normalize(new Vector2(speedX, speedY - 2)) * 18f;
