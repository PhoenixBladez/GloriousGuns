...
{
	public class SMG_DahlMaliwanCorrosive : ModItem
	{
		...
		public string WeaponName => RandNames[nameIndex%RandNames.Length]+" Scorpion";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Dahl/SMGWhite/SMG_DahlMaliwanCorrosiveGlow");
		}
		...
		{
			var myClone = (SMG_DahlMaliwanCorrosive)base.Clone(itemClone);
        	...
        	public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Dahl/SMGWhite/SMG_DahlMaliwanCorrosiveGlow"),
				new Vector2
				(
		...
		public void Generate()
		{
			...
			item.useAnimation = item.useTime = new UnifiedRandom().Next(10, 12);
