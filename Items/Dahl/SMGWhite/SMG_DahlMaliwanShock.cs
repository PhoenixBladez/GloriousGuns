...
{
	public class SMG_DahlMaliwanShock : ModItem
	{
		...
		public string WeaponName => RandNames[nameIndex%RandNames.Length]+" Eel";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Dahl/SMGWhite/SMG_DahlMaliwanShockGlow");
		}
		...
		{
			var myClone = (SMG_DahlMaliwanShock)base.Clone(itemClone);
        	...
        	public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Dahl/SMGWhite/SMG_DahlMaliwanShockGlow"),
				new Vector2
				(
