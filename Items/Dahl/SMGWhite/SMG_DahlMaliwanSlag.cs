...
{
	public class SMG_DahlMaliwanSlag : ModItem
	{
		...
		public string WeaponName => RandNames[nameIndex%RandNames.Length]+" Jackal";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Dahl/SMGWhite/SMG_DahlMaliwanSlagGlow");
		}
		...
		{
			var myClone = (SMG_DahlMaliwanSlag)base.Clone(itemClone);
        	...
        	public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Dahl/SMGWhite/SMG_DahlMaliwanSlagGlow"),
				new Vector2
				(
