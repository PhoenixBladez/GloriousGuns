...
{
	public class DahlRifle_Shock : ModItem
	{
		...
		public string WeaponName => "Sapping " + RandNames[nameIndex%RandNames.Length]+" Rifle";
		...
		public override void SetStaticDefaults()
		{
            ...
            GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Dahl/ARWhite/DahlRifle_ShockGlow");
		}
		...
		{
			var myClone = (DahlRifle_Shock)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Dahl/ARWhite/DahlRifle_ShockGlow"),
				new Vector2
				(
