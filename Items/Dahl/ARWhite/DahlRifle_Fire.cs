...
{
	public class DahlRifle_Fire : ModItem
	{
		...
		public string WeaponName => "Incendiary " + RandNames[nameIndex%RandNames.Length]+" Rifle";
		...
		public override void SetStaticDefaults()
		{
            ...
            GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Dahl/ARWhite/DahlRifle_FireGlow");
		}
		...
		{
			var myClone = (DahlRifle_Fire)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Dahl/ARWhite/DahlRifle_FireGlow"),
				new Vector2
				(
