...
{
	public class DahlRifle_Slag : ModItem
	{
		...
		public string WeaponName => "Slag " + RandNames[nameIndex%RandNames.Length]+" Rifle";
		...
		public override void SetStaticDefaults()
		{
            ...
            GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Dahl/ARWhite/DahlRifle_SlagGlow");
		}
		...
		{
			var myClone = (DahlRifle_Slag)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Dahl/ARWhite/DahlRifle_SlagGlow"),
				new Vector2
				(
