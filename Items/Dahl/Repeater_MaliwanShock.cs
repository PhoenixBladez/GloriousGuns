...
{
	public class Repeater_MaliwanShock : ModItem
	{
		...
		public string WeaponName => "Sapping " + RandNames[nameIndex%RandNames.Length]+" Repeater";
		...
		public override void SetStaticDefaults()
		{
            ...
            GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Dahl/Repeater_MaliwanShockGlow");
		}
		...
		{
			var myClone = (Repeater_MaliwanShock)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Dahl/Repeater_MaliwanShockGlow"),
				new Vector2
				(
		...
		{
			Lighting.AddLight(item.position,0.3f, 0.2f, 0.6f);
			Texture2D texture;
            texture = Main.itemTexture[item.type];
