...
{
	public class Repeater_MaliwanSlag : ModItem
	{
		...
		public string WeaponName => "Tactical " + RandNames[nameIndex%RandNames.Length]+" Repeater";
		...
		public override void SetStaticDefaults()
		{
            ...
            GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Dahl/Repeater_MaliwanSlagGlow");
		}
		...
		{
			var myClone = (Repeater_MaliwanSlag)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Dahl/Repeater_MaliwanSlagGlow"),
				new Vector2
				(
