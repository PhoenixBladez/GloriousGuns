...
namespace GloriousGuns.Items.Jakobs.ShotgunWhite
{
	public class CoachGun : ModItem
	{
		...
		public int revolverBullets = 3;
		//protected int counter;

		public string WeaponName => RandNames[nameIndex%RandNames.Length]+" Coach Gun";
		...
		{
			var myClone = (CoachGun)base.Clone(itemClone);
		...
		public override bool Shoot(Player player,ref Vector2 position,ref float speedX,ref float speedY,ref int type,ref int damage,ref float knockBack)
		{
			...
			for (int X = 0; X <= 5; X++)
			{
                float spread = MathHelper.ToRadians(60f); //45 degrees converted to radians
		...
		public void Generate()
		{
			...
			item.damage =  GloriousGuns.instance.gloriousRNG.Next(11,16);
