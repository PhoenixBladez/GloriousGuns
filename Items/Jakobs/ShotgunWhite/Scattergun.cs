...
namespace GloriousGuns.Items.Jakobs.ShotgunWhite
{
	public class Scattergun : ModItem
	{
		...
		public string WeaponName => RandNames[nameIndex%RandNames.Length]+" Scattergun";
		...
		{
			var myClone = (Scattergun)base.Clone(itemClone);
		...
		public override bool Shoot(Player player,ref Vector2 position,ref float speedX,ref float speedY,ref int type,ref int damage,ref float knockBack)
		{
			...
			for (int X = 0; X <= 3; X++)
			{
                float spread = MathHelper.ToRadians(46f); //45 degrees converted to radians
