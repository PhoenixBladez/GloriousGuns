...
{
	public class Revolver_Dahl : ModItem
	{
		...
		{
			var myClone = (Revolver_Dahl)base.Clone(itemClone);
		...
		public override bool Shoot(Player player,ref Vector2 position,ref float speedX,ref float speedY,ref int type,ref int damage,ref float knockBack)
		{
			...
			float spread = MathHelper.ToRadians(18f/revolverBullets); //45 degrees converted to radians
