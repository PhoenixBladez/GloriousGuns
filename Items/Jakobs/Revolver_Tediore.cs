...
namespace GloriousGuns.Items.Jakobs
{
	public class Revolver_Tediore : ModItem
	{
		...
		{
			var myClone = (Revolver_Tediore)base.Clone(itemClone);
		...
		public override bool Shoot(Player player,ref Vector2 position,ref float speedX,ref float speedY,ref int type,ref int damage,ref float knockBack)
		{
			...
			float spread = MathHelper.ToRadians(22f/revolverBullets); //45 degrees converted to radians
		...
		public void Generate()
		{
			...
			item.useAnimation = item.useTime = new UnifiedRandom().Next(6, 7);
