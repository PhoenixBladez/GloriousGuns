...
{
	public class Apparatus_MaliwanSlag : ModItem
	{
		...
		public string WeaponName => "Amplifying " + RandNames[nameIndex%RandNames.Length]+" Apparatus";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Hyperion/Apparatus_MaliwanSlagGlow");
		}
		...
		{
			var myClone = (Apparatus_MaliwanSlag)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Hyperion/Apparatus_MaliwanSlagGlow"),
				new Vector2
				(
