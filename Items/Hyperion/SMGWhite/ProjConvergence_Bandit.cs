...
{
	public class ProjConvergence_Bandit : ModItem
	{
		...
		{
			var myClone = (ProjConvergence_Bandit)base.Clone(itemClone);
		...
		public override bool Shoot(Player player,ref Vector2 position,ref float speedX,ref float speedY,ref int type,ref int damage,ref float knockBack)
		{
			...
			float spread = MathHelper.ToRadians(.53f*SMGBullets); //45 degrees converted to radians
