...
{
	public class ProjConvergence_Maliwan : ModItem
	{
		...
		{
			var myClone = (ProjConvergence_Maliwan)base.Clone(itemClone);
		...
		public void Generate()
		{
			...
			SMGBulletsMax = GloriousGuns.instance.gloriousRNG.Next(45, 55);
