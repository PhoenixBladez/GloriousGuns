...
{
	public class ProjConvergence_MaliwanCorrosive : ModItem
	{
		...
		public string WeaponName => "Rendering " + RandNames[nameIndex%RandNames.Length]+" Projectile Convergence";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Hyperion/SMGWhite/ProjConvergence_MaliwanCorrosiveGlow");	
		}
		...
		{
			var myClone = (ProjConvergence_MaliwanCorrosive)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Hyperion/SMGWhite/ProjConvergence_MaliwanCorrosiveGlow"),
				new Vector2
				(
		...
		public void Generate()
		{
			...
			SMGBulletsMax = new UnifiedRandom().Next(35, 50);
			item.shootSpeed =  new UnifiedRandom().NextFloat(8f,10f);
