...
{
	public class ProjConvergence_MaliwanShock : ModItem
	{
		...
		public string WeaponName => "Energetic " + RandNames[nameIndex%RandNames.Length]+" Projectile Convergence";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Hyperion/SMGWhite/ProjConvergence_MaliwanShockGlow");	
		}
		...
		{
			var myClone = (ProjConvergence_MaliwanShock)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Hyperion/SMGWhite/ProjConvergence_MaliwanShockGlow"),
				new Vector2
				(
