...
{
	public class ProjConvergence_Tediore : ModItem
	{
		...
		public string WeaponName => RandNames[nameIndex%RandNames.Length]+" Projectile Convergence";
		...
		{
			var myClone = (ProjConvergence_Tediore)base.Clone(itemClone);
		...
		public override bool Shoot(Player player,ref Vector2 position,ref float speedX,ref float speedY,ref int type,ref int damage,ref float knockBack)
		{
			...
			float spread = MathHelper.ToRadians(.4f*SMGBullets); //45 degrees converted to radians
