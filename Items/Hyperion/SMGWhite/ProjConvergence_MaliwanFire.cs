...
{
	public class ProjConvergence_MaliwanFire : ModItem
	{
		...
		public string WeaponName => "Intensified " + RandNames[nameIndex%RandNames.Length]+" Projectile Convergence";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Hyperion/SMGWhite/ProjConvergence_MaliwanFireGlow");	
		}
		...
		{
			var myClone = (ProjConvergence_MaliwanFire)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Hyperion/SMGWhite/ProjConvergence_MaliwanFireGlow"),
				new Vector2
				(
