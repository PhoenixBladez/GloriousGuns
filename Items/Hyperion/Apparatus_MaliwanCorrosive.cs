...
{
	public class Apparatus_MaliwanCorrosive : ModItem
	{
		...
		public string WeaponName => "Base " + RandNames[nameIndex%RandNames.Length]+" Apparatus";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Hyperion/Apparatus_MaliwanCorrosiveGlow");	
		}
		...
		{
			var myClone = (Apparatus_MaliwanCorrosive)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Hyperion/Apparatus_MaliwanCorrosiveGlow"),
				new Vector2
				(
		...
		public void Generate()
		{
            ...
            item.reuseDelay = GloriousGuns.instance.gloriousRNG.Next(10,15);
