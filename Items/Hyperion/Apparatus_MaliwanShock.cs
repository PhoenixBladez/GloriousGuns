...
{
	public class Apparatus_MaliwanShock : ModItem
	{
		...
		public string WeaponName => "Energizing " + RandNames[nameIndex%RandNames.Length]+" Apparatus";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Hyperion/Apparatus_MaliwanShockGlow");
		}
		...
		{
			var myClone = (Apparatus_MaliwanShock)base.Clone(itemClone);
		...
		public override bool Shoot(Player player,ref Vector2 position,ref float speedX,ref float speedY,ref int type,ref int damage,ref float knockBack)
		{
			...
			Main.projectile[projectileFired].GetGlobalProjectile<GloriousGunsGProj>().shotFromShockWeaponCommon = true;
			return false;
		}
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Hyperion/Apparatus_MaliwanShockGlow"),
				new Vector2
				(
		...
		public void Generate()
		{
			...
			item.useAnimation = item.useTime = GloriousGuns.instance.gloriousRNG.Next(5, 6);
			item.damage =  GloriousGuns.instance.gloriousRNG.Next(12,16);
			item.knockBack =  GloriousGuns.instance.gloriousRNG.Next(1,2);
			item.value = GloriousGuns.instance.gloriousRNG.Next(5000,10000);
            item.crit = GloriousGuns.instance.gloriousRNG.Next(5, 8);
            item.reuseDelay = GloriousGuns.instance.gloriousRNG.Next(10,13);
