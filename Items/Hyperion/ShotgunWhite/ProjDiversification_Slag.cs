...
{
	public class ProjDiversification_Slag : ModItem
	{
		...
		public string WeaponName => "Negative " + RandNames[nameIndex%RandNames.Length]+" Projectile Diversification";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Hyperion/ShotgunWhite/ProjDiversification_SlagGlow");
		}
		...
		{
			var myClone = (ProjDiversification_Slag)base.Clone(itemClone);
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Hyperion/ShotgunWhite/ProjDiversification_SlagGlow"),
				new Vector2
				(
