...
{
	public class ProjDiversification_Shock : ModItem
	{
		...
		public string WeaponName => "Conductive " + RandNames[nameIndex%RandNames.Length]+" Projectile Diversification";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Hyperion/ShotgunWhite/ProjDiversification_ShockGlow");
		}
		...
		{
			var myClone = (ProjDiversification_Shock)base.Clone(itemClone);
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Hyperion/ShotgunWhite/ProjDiversification_ShockGlow"),
				new Vector2
				(
        ...
        }		public void Generate()
		{
			...
			item.useAnimation = item.useTime = new UnifiedRandom().Next(35, 45);
			item.damage =  new UnifiedRandom().Next(9,13);
			item.knockBack =  new UnifiedRandom().Next(3,6);
			item.value = new UnifiedRandom().Next(12000,20000);
			item.shootSpeed =  new UnifiedRandom().NextFloat(5f,9f);
