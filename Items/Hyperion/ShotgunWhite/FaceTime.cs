...
namespace GloriousGuns.Items.Hyperion.ShotgunWhite
{
	public class FaceTime : ModItem
	{
		...
		public string WeaponName => RandNames[nameIndex%RandNames.Length]+" Face Time";
		...
		{
			var myClone = (FaceTime)base.Clone(itemClone);
		...
		public void Generate()
		{
			...
			item.useAnimation = item.useTime = GloriousGuns.instance.gloriousRNG.Next(40, 50);
			item.damage =  GloriousGuns.instance.gloriousRNG.Next(8,12);
			item.knockBack =  GloriousGuns.instance.gloriousRNG.Next(3,7);
