...
{
	public class Handgun_MaliwanShock : ModItem
	{
		...
		public string WeaponName => "Energizing " + RandNames[nameIndex%RandNames.Length]+" Handgun";
		...
		{
			var myClone = (Handgun_MaliwanShock)base.Clone(itemClone);
		...
		public override bool Shoot(Player player,ref Vector2 position,ref float speedX,ref float speedY,ref int type,ref int damage,ref float knockBack)
		{
			...
			if (handgunBullets == 1)
			{
				...
				type = mod.ProjectileType("Handgun_MaliwanShockProj");
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Tediore/Handgun_MaliwanShockGlow"),
				new Vector2
				(
