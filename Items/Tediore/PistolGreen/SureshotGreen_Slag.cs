...
{
	public class SureshotGreen_Slag : ModItem
	{
		public static string[] RandNames = { "Incredible","Value","Clearance","Bulk","Target", "Disposable", "Top-Notch" };
		protected ushort nameIndex;
		//protected int counter;

		public string WeaponName => "Extra-Special " + RandNames[nameIndex%RandNames.Length]+" Sureshot";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Tediore/PistolGreen/SureshotGreen_SlagGlow");
		}
		...
		{
			var myClone = (SureshotGreen_Slag)base.Clone(itemClone);
	    ...
	    public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Tediore/PistolGreen/SureshotGreen_SlagGlow"),
				new Vector2
				(
    	...
    	public override void ModifyTooltips(List<TooltipLine> tooltips)
		{
           ...
           TooltipLine line3 = new TooltipLine(mod, "ItemName", "Slag Weapon\nNon-slagged attacks on slagged enemies deal double damage");
            line3.overrideColor = new Color(100, 0, 200);
            tooltips.Add(line3);
		}
	}
}