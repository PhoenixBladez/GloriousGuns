...
namespace GloriousGuns.Items.Tediore.PistolGreen
{
	public class SureshotGreen_Fire : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Tediore/PistolGreen/SureshotGreen_FireGlow");
		}
		...
		{
			var myClone = (SureshotGreen_Fire)base.Clone(itemClone);
	    ...
	    public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Tediore/PistolGreen/SureshotGreen_FireGlow"),
				new Vector2
				(
    	...
    	public override void ModifyTooltips(List<TooltipLine> tooltips)
		{
	        ...
	        TooltipLine line3 = new TooltipLine(mod, "ItemName", "Incendiary Weapon\nAttacks deal ravaging fire damage");
            line3.overrideColor = new Color(224, 64, 15);
            tooltips.Add(line3);   
		}
	}
}