...
{
	public class SureshotGreen_Corrosive : ModItem
	{
		public static string[] RandNames = { "Incredible","Value","Clearance","Bulk","Target", "Disposable", "Top-Notch" };
		protected ushort nameIndex;
		//protected int counter;

		public string WeaponName => "Minty " +RandNames[nameIndex%RandNames.Length]+" Sureshot";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Tediore/PistolGreen/SureshotGreen_CorrosiveGlow");
		}
		...
		{
			var myClone = (SureshotGreen_Corrosive)base.Clone(itemClone);
	    ...
	    public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Tediore/PistolGreen/SureshotGreen_CorrosiveGlow"),
				new Vector2
				(
    	...
    	public override void ModifyTooltips(List<TooltipLine> tooltips)
		{
			...
			TooltipLine line3 = new TooltipLine(mod, "ItemName", "Corrosive Weapon\nCorrosive Acid deals more damage the less life the target has");
            line3.overrideColor = new Color(97, 198, 29);
            tooltips.Add(line3);      
		}
	}
}