...
{
	public class Sportsman_Corrosive : ModItem
	{
		...
		public string WeaponName => "Springtime " + RandNames[nameIndex%RandNames.Length]+" Sportsman";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Tediore/ShotgunWhite/Sportsman_CorrosiveGlow");
		}
		...
		{
			var myClone = (Sportsman_Corrosive)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Tediore/ShotgunWhite/Sportsman_CorrosiveGlow"),
				new Vector2
				(
