...
{
	public class DoubleBarrels : ModItem
	{
		...
		public string WeaponName => RandNames[nameIndex%RandNames.Length]+" Double Barrels!";
		...
		{
			var myClone = (DoubleBarrels)base.Clone(itemClone);
