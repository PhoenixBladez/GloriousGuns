...
{
	public class DoubleBarrels_Slag : ModItem
	{
		...
		public string WeaponName => "Boosted " + RandNames[nameIndex%RandNames.Length]+" Double Barrels!";
		...
		{
			DisplayName.SetDefault("Double Barrels");
			Tooltip.SetDefault("Consumes 2 ammo per shot\nThrown like a grenade when reloaded\nReloads every "+ 4 + " shots");
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Tediore/ShotgunWhite/DoubleBarrels_SlagGlow");
		}
		...
		{
			var myClone = (DoubleBarrels_Slag)base.Clone(itemClone);
		...
		public override bool Shoot(Player player,ref Vector2 position,ref float speedX,ref float speedY,ref int type,ref int damage,ref float knockBack)
		{
          for (int index = 0; index < 58; ++index)
          {
			...
			if (shotgunBullets == 1)
			{
				...
				type = mod.ProjectileType("DoubleBarrels_Proj");
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Tediore/ShotgunWhite/DoubleBarrels_SlagGlow"),
				new Vector2
				(
		...
		public void Generate()
		{
            ...
            item.reuseDelay = GloriousGuns.instance.gloriousRNG.Next(15,22);
