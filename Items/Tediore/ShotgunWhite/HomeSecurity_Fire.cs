...
{
	public class HomeSecurity_Fire : ModItem
	{
		...
		public string WeaponName => "Sunny " + RandNames[nameIndex%RandNames.Length]+" Home Security";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Tediore/ShotgunWhite/HomeSecurity_FireGlow");
		}
		...
		{
			var myClone = (HomeSecurity_Fire)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Tediore/ShotgunWhite/HomeSecurity_FireGlow"),
				new Vector2
				(
		...
		public void Generate()
		{
			...
			item.useAnimation = item.useTime = GloriousGuns.instance.gloriousRNG.Next(25, 35);
			item.damage =  GloriousGuns.instance.gloriousRNG.Next(9,11);
			item.knockBack =  GloriousGuns.instance.gloriousRNG.Next(5, 8);
			item.value = GloriousGuns.instance.gloriousRNG.Next(6000, 14000);
