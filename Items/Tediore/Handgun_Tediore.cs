...
{
	public class Handgun_Tediore : ModItem
	{
		...
		public string WeaponName => RandNames[nameIndex%RandNames.Length]+" Handgun";
		...
		{
			var myClone = (Handgun_Tediore)base.Clone(itemClone);
		...
		public override bool Shoot(Player player,ref Vector2 position,ref float speedX,ref float speedY,ref int type,ref int damage,ref float knockBack)
		{
			...
			float spread = MathHelper.ToRadians(22f/handgunBullets); //45 degrees converted to radians
			...
			if (handgunBullets == 1)
			{
				...
				type = mod.ProjectileType("Handgun_TedioreProj");
		...
		public void Generate()
		{
			...
			item.damage =  new UnifiedRandom().Next(9,12);
