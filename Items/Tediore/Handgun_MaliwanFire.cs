...
{
	public class Handgun_MaliwanFire : ModItem
	{
		...
		public string WeaponName => "Red Hot " + RandNames[nameIndex%RandNames.Length]+" Handgun";
		...
		{
			var myClone = (Handgun_MaliwanFire)base.Clone(itemClone);
		...
		public override bool Shoot(Player player,ref Vector2 position,ref float speedX,ref float speedY,ref int type,ref int damage,ref float knockBack)
		{
			...
			if (handgunBullets == 1)
			{
				...
				type = mod.ProjectileType("Handgun_MaliwanFireProj");
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Tediore/Handgun_MaliwanFireGlow"),
				new Vector2
				(
