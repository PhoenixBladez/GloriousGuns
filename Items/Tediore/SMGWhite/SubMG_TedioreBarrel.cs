...
{
	public class SubMG_TedioreBarrel : ModItem
	{
		...
		{
			var myClone = (SubMG_TedioreBarrel)base.Clone(itemClone);
		...
		public override bool Shoot(Player player,ref Vector2 position,ref float speedX,ref float speedY,ref int type,ref int damage,ref float knockBack)
		{
			...
			float spread = MathHelper.ToRadians(15f); //45 degrees converted to radians
		...
		public void Generate()
		{
			...
			SMGBulletsMax = GloriousGuns.instance.gloriousRNG.Next(60, 80);
