...
{
	public class SubMG_MaliwanFire : ModItem
	{
		...
		public string WeaponName => "Kindle " + RandNames[nameIndex%RandNames.Length]+" Subcompact MG";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Tediore/SMGWhite/SubMG_MaliwanFireGlow");	
		}
		...
		{
			var myClone = (SubMG_MaliwanFire)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Tediore/SMGWhite/SubMG_MaliwanFireGlow"),	
				new Vector2
				(
