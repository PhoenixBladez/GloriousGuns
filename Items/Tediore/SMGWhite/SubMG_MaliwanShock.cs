...
{
	public class SubMG_MaliwanShock : ModItem
	{
		...
		public string WeaponName => "Spark " + RandNames[nameIndex%RandNames.Length]+" Subcompact MG";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Tediore/SMGWhite/SubMG_MaliwanShockGlow");	
		}
		...
		{
			var myClone = (SubMG_MaliwanShock)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Tediore/SMGWhite/SubMG_MaliwanShockGlow"),	
				new Vector2
				(
