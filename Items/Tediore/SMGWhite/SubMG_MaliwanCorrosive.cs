...
{
	public class SubMG_MaliwanCorrosive : ModItem
	{
		...
		public string WeaponName => "Green " + RandNames[nameIndex%RandNames.Length]+" Subcompact MG";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Tediore/SMGWhite/SubMG_MaliwanCorrosiveGlow");	
		}
		...
		{
			var myClone = (SubMG_MaliwanCorrosive)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Tediore/SMGWhite/SubMG_MaliwanCorrosiveGlow"),	
				new Vector2
				(
		...
		public void Generate()
		{
			...
			item.useAnimation = item.useTime = new UnifiedRandom().Next(8, 10);
			...
			SMGBulletsMax = new UnifiedRandom().Next(55, 77);
