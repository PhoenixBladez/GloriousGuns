...
{
	public class SubMG_MaliwanSlag : ModItem
	{
		...
		public string WeaponName => "Chaff " + RandNames[nameIndex%RandNames.Length]+" Subcompact MG";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Tediore/SMGWhite/SubMG_MaliwanSlagGlow");	
		}
		...
		{
			var myClone = (SubMG_MaliwanSlag)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Tediore/SMGWhite/SubMG_MaliwanSlagGlow"),	
				new Vector2
				(
