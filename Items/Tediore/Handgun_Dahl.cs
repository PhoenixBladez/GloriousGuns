...
{
	public class Handgun_Dahl : ModItem
	{
		...
		{
			var myClone = (Handgun_Dahl)base.Clone(itemClone);
		...
		public override bool Shoot(Player player,ref Vector2 position,ref float speedX,ref float speedY,ref int type,ref int damage,ref float knockBack)
		{
			...
			float spread = MathHelper.ToRadians(10f); //45 degrees converted to radians
			...
			if (handgunBullets == 1)
			{
				...
				type = mod.ProjectileType("Handgun_DahlProj");
