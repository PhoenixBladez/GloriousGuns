...
namespace GloriousGuns.Items.Maliwan.SMGWhite
{
	public class Gospel_Corrosive : ModItem
	{
		...
		public string WeaponName => "Caustic Gospel";
		...
		{
			DisplayName.SetDefault("Gospel");
			Tooltip.SetDefault("Firing increases accuracy\nAccuracy resets each clip");
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Maliwan/SMGWhite/Gospel_CorrosiveGlow");	
		}
		...
		{
			var myClone = (Gospel_Corrosive)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Maliwan/SMGWhite/Gospel_CorrosiveGlow"),
				new Vector2
				(
