...
{
	public class Gospel_Fire : ModItem
	{
		...
		public string WeaponName => "Fervid Gospel";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Maliwan/SMGWhite/Gospel_FireGlow");	
		}
		...
		{
			var myClone = (Gospel_Fire)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Maliwan/SMGWhite/Gospel_FireGlow"),
				new Vector2
				(
