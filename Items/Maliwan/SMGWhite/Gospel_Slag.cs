...
{
	public class Gospel_Slag : ModItem
	{
		...
		public string WeaponName => "Feculent Gospel";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Maliwan/SMGWhite/Gospel_SlagGlow");	
		}
		...
		{
			var myClone = (Gospel_Slag)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Maliwan/SMGWhite/Gospel_SlagGlow"),
				new Vector2
				(
