...
{
	public class Gospel_Shock : ModItem
	{
		...
		public string WeaponName => "Storming Gospel";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Maliwan/SMGWhite/Gospel_ShockGlow");	
		}
		...
		{
			var myClone = (Gospel_Shock)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Maliwan/SMGWhite/Gospel_ShockGlow"),
				new Vector2
				(
