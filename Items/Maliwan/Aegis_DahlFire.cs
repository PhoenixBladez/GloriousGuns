...
{
	public class Aegis_DahlFire : ModItem
	{
		...
		public string WeaponName => "Inflammatory Aegis";
		...
		public override void SetStaticDefaults()
		{
            ...
            GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Maliwan/Aegis_Fire");
		}
		...
		{
			var myClone = (Aegis_DahlFire)base.Clone(itemClone);
		...
		public override bool Shoot(Player player,ref Vector2 position,ref float speedX,ref float speedY,ref int type,ref int damage,ref float knockBack)
		{
			...
			Main.projectile[projectileFired].GetGlobalProjectile<GloriousGunsGProj>(mod).shotFromMaliwanFireCommon = true;
			return false;
		}
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Maliwan/Aegis_Fire"),
				new Vector2
				(
		...
		public void Generate()
		{
			...
			item.knockBack =  GloriousGuns.instance.gloriousRNG.Next(2,3);
