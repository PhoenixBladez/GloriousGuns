...
{
	public class Aegis_DahlCorrosive : ModItem
	{
		...
		public string WeaponName => "Trenchant Aegis";
		...
		public override void SetStaticDefaults()
		{
            ...
            GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Maliwan/Aegis_Corrosive");
		}
		...
		{
			var myClone = (Aegis_DahlCorrosive)base.Clone(itemClone);
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Maliwan/Aegis_Corrosive"),
				new Vector2
				(
