...
{
	public class Pistal_MaliwanSlag : ModItem
	{
		...
		public string WeaponName => "Slagged " + RandNames[nameIndex%RandNames.Length] +" Pistal";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Bandit/Pistal_MaliwanSlagGlow");
		}
		...
		{
			var myClone = (Pistal_MaliwanSlag)base.Clone(itemClone);
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Bandit/Pistal_MaliwanSlagGlow"),
				new Vector2
				(
