...
{
	public class Pistal_MaliwanCorrosive : ModItem
	{
		...
		public string WeaponName => "Asidy " + RandNames[nameIndex%RandNames.Length] +" Pistal";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Bandit/Pistal_MaliwanCorrosiveGlow");
		}
		...
		{
			var myClone = (Pistal_MaliwanCorrosive)base.Clone(itemClone);
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Bandit/Pistal_MaliwanCorrosiveGlow"),
				new Vector2
				(
