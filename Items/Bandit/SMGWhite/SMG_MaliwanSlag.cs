...
{
	public class SMG_MaliwanSlag : ModItem
	{
		...
		public string WeaponName => "Slagy"+" Smig";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Bandit/SMGWhite/SMG_MaliwanSlagGlow");
		}
		...
		{
			var myClone = (SMG_MaliwanSlag)base.Clone(itemClone);
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Bandit/SMGWhite/SMG_MaliwanSlagGlow"),
				new Vector2
				(
