...
{
	public class SMG_MaliwanShock : ModItem
	{
		...
		public string WeaponName => "Shoky"+" Smig";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Bandit/SMGWhite/SMG_MaliwanShockGlow");
		}
		...
		{
			var myClone = (SMG_MaliwanShock)base.Clone(itemClone);
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Bandit/SMGWhite/SMG_MaliwanShockGlow"),
				new Vector2
				(
		...
		public void Generate()
		{
			...
			item.useAnimation = item.useTime = GloriousGuns.instance.gloriousRNG.Next(7, 9);
			item.damage =  GloriousGuns.instance.gloriousRNG.Next(3,5);
			item.knockBack =  GloriousGuns.instance.gloriousRNG.Next(0,1);
			item.value = GloriousGuns.instance.gloriousRNG.Next(12000,15000);
			SMGBulletsMax = GloriousGuns.instance.gloriousRNG.Next(50, 60);
