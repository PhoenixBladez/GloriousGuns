...
{
	public class SMG_MaliwanFire : ModItem
	{
		...
		public string WeaponName => "Burny"+" Smig";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Bandit/SMGWhite/SMG_MaliwanFireGlow");
		}
		...
		{
			var myClone = (SMG_MaliwanFire)base.Clone(itemClone);
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Bandit/SMGWhite/SMG_MaliwanFireGlow"),
				new Vector2
				(
