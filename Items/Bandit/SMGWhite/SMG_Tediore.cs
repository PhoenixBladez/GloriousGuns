...
{
	public class SMG_Tediore : ModItem
	{
		...
		{
			var myClone = (SMG_Tediore)base.Clone(itemClone);
		...
		public override bool Shoot(Player player,ref Vector2 position,ref float speedX,ref float speedY,ref int type,ref int damage,ref float knockBack)
		{
			...
			float spread = MathHelper.ToRadians(16f); //45 degrees converted to radians
		...
		public void Generate()
		{
			...
			item.reuseDelay = GloriousGuns.instance.gloriousRNG.Next(5, 8);
			item.value = GloriousGuns.instance.gloriousRNG.Next(12000,15000);
			SMGBulletsMax = GloriousGuns.instance.gloriousRNG.Next(100, 120);
