...
{
	public class HoleyMan_Corrosive : ModItem
	{
		public static string[] RandNames = { "Dayumned","Say Krud","Shoty","Eezy","Broosin", "Hurrty", "Moar" };
		protected ushort nameIndex;
		//protected int counter;

		public string WeaponName =>  "Pznous " + RandNames[nameIndex%RandNames.Length]+" Holey Man";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Bandit/PistolGreen/HoleyMan_CorrosiveGlow");
		}
		...
		{
			var myClone = (HoleyMan_Corrosive)base.Clone(itemClone);
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Bandit/PistolGreen/HoleyMan_CorrosiveGlow"),
				new Vector2
				(
