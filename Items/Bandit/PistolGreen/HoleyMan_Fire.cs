...
{
	public class HoleyMan_Fire : ModItem
	{
		public static string[] RandNames = { "Dayumned","Say Krud","Shoty","Eezy","Broosin", "Hurrty", "Moar" };
		protected ushort nameIndex;
		//protected int counter;

		public string WeaponName =>  "Hawt " + RandNames[nameIndex%RandNames.Length]+" Holey Man";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Bandit/PistolGreen/HoleyMan_FireGlow");
		}
		...
		{
			var myClone = (HoleyMan_Fire)base.Clone(itemClone);
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Bandit/PistolGreen/HoleyMan_FireGlow"),
				new Vector2
				(
