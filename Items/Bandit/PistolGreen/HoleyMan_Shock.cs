...
{
	public class HoleyMan_Shock : ModItem
	{
		public static string[] RandNames = { "Dayumned","Say Krud","Shoty","Eezy","Broosin", "Hurrty", "Moar" };
		protected ushort nameIndex;
		//protected int counter;

		public string WeaponName =>  "Shocky " + RandNames[nameIndex%RandNames.Length]+" Holey Man";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Bandit/PistolGreen/HoleyMan_ShockGlow");
		}
		...
		{
			var myClone = (HoleyMan_Shock)base.Clone(itemClone);
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Bandit/PistolGreen/HoleyMan_ShockGlow"),
				new Vector2
				(
