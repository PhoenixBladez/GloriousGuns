...
{
	public class RagneKiller_HyperionFire : ModItem
	{
		...
		public string WeaponName => "Fier " + RandNames[nameIndex%RandNames.Length]+" Long Ragne Killer";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Bandit/ShotgunWhite/RagneKiller_HyperionFireGlow");
		}
		...
		{
			var myClone = (RagneKiller_HyperionFire)base.Clone(itemClone);
		...
		public void Generate()
		{
			...
			item.useAnimation = item.useTime = new UnifiedRandom().Next(30, 40);
			item.damage =  new UnifiedRandom().Next(9,13);
			item.knockBack =  new UnifiedRandom().Next(4,7);
			item.reuseDelay = new UnifiedRandom().Next(15,25);
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Bandit/ShotgunWhite/RagneKiller_HyperionFireGlow"),
				new Vector2
				(
