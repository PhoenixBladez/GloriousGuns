...
{
	public class RagneKiller_Hyperion2 : ModItem
	{
		...
		public string WeaponName => RandNames[nameIndex%RandNames.Length]+" Long Ragne Killer";
		...
		{
			var myClone = (RagneKiller_Hyperion2)base.Clone(itemClone);
