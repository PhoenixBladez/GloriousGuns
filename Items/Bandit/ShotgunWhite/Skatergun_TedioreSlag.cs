...
{
	public class Skatergun_TedioreSlag : ModItem
	{
		...
		public string WeaponName => "Salged " + RandNames[nameIndex%RandNames.Length]+" Skatergun";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Bandit/ShotgunWhite/Skatergun_TedioreSlagGlow");
		}
		...
		{
			var myClone = (Skatergun_TedioreSlag)base.Clone(itemClone);
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Bandit/ShotgunWhite/Skatergun_TedioreSlagGlow"),
				new Vector2
				(
		...
		public void Generate()
		{
			...
			item.damage =  new UnifiedRandom().Next(11,14);
