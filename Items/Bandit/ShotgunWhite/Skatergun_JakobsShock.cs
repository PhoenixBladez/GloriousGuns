...
{
	public class Skatergun_JakobsShock : ModItem
	{
		...
		public string WeaponName => "Zapper " + RandNames[nameIndex%RandNames.Length]+" Stret Sweper";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Bandit/ShotgunWhite/Skatergun_JakobsShockGlow");
		...
		{
			var myClone = (Skatergun_JakobsShock)base.Clone(itemClone);
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Bandit/ShotgunWhite/Skatergun_JakobsShockGlow"),
				new Vector2
				(
