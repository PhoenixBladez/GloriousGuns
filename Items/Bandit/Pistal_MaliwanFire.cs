...
{
	public class Pistal_MaliwanFire : ModItem
	{
		...
		public string WeaponName => "Burny " + RandNames[nameIndex%RandNames.Length] +" Pistal";
		...
		public override void SetStaticDefaults()
		{
			...
			GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Bandit/Pistal_MaliwanFireGlow");
		}
		...
		{
			var myClone = (Pistal_MaliwanFire)base.Clone(itemClone);
		...
		{
			Lighting.AddLight(item.position,0.4f, 0.12f, 0.06f);
			Texture2D texture;
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Bandit/Pistal_MaliwanFireGlow"),
				new Vector2
				(
