...
{
	public class Pistal_Bandit : ModItem
	{
		...
		public string WeaponName => RandNames[nameIndex%RandNames.Length]+" Pistal";
		...
		{
			var myClone = (Pistal_Bandit)base.Clone(itemClone);
		...
		public override bool Shoot(Player player,ref Vector2 position,ref float speedX,ref float speedY,ref int type,ref int damage,ref float knockBack)
		{
			...
			float spread = MathHelper.ToRadians(25f); //45 degrees converted to radians
		...
		public void Generate()
		{
			...
			item.useAnimation = item.useTime = GloriousGuns.instance.gloriousRNG.Next(20, 30);
			item.damage =  GloriousGuns.instance.gloriousRNG.Next(13,16);
