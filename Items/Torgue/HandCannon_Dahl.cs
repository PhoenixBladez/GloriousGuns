...
{
	public class HandCannon_Dahl : ModItem
	{
		...
		{
			var myClone = (HandCannon_Dahl)base.Clone(itemClone);
		...
		public void Generate()
		{
			...
			item.useAnimation = item.useTime = new UnifiedRandom().Next(16, 25);
			item.damage =  new UnifiedRandom().Next(16,21);
