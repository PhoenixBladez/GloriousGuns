...
{
	public class Pounder : TorgueGun
	{
		...
		public override string WeaponName => RandNames[nameIndex%RandNames.Length]+" Pounder";
		...
		{
			DisplayName.SetDefault("Pounder");
		...
		public override bool Shoot(Player player,ref Vector2 position,ref float speedX,ref float speedY,ref int type,ref int damage,ref float knockBack)
		{
			...
			float spread = MathHelper.ToRadians(52f); //45 degrees converted to radians
		...
		public override void Generate()
		{
			...
			item.useAnimation = item.useTime = GloriousGuns.instance.gloriousRNG.Next(36, 46);
            ...
            item.reuseDelay = GloriousGuns.instance.gloriousRNG.Next(25,30);
