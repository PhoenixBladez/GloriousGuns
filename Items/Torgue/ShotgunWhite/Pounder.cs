...
namespace GloriousGuns.Items.Torgue.ShotgunWhite
{
	public class Pounder : ModItem
	{
		...
		public string WeaponName => RandNames[nameIndex%RandNames.Length]+" Pounder";
		...
		{
			var myClone = (Pounder)base.Clone(itemClone);
		...
		public void Generate()
		{
			...
			item.useAnimation = item.useTime = new UnifiedRandom().Next(36, 46);
            ...
            item.reuseDelay = new UnifiedRandom().Next(25,30);
