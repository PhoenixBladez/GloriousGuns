...
{
	public class PocketRocket_Slag : ModItem
	{
		public static string[] RandNames = { "Shredded","Ripped","Jacked","Hard","Stiff", "Tough", "Compressed" };
		protected ushort nameIndex;
		//protected int counter;

		public string WeaponName =>  "Veiny " + RandNames[nameIndex%RandNames.Length]+" Pocket Rocket";
		...
		public override void SetStaticDefaults()
		{
            ...
            GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Torgue/PistolGreen/PocketRocket_SlagGlow");		
		}
		...
		{
			var myClone = (PocketRocket_Slag)base.Clone(itemClone);
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Torgue/PistolGreen/PocketRocket_SlagGlow"),
				new Vector2
				(
