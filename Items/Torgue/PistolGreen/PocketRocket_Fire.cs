...
{
	public class PocketRocket_Fire : ModItem
	{
		public static string[] RandNames = { "Shredded","Ripped","Jacked","Hard","Stiff", "Tough", "Compressed" };
		protected ushort nameIndex;
		//protected int counter;

		public string WeaponName =>  "Sizzlin' " + RandNames[nameIndex%RandNames.Length]+" Pocket Rocket";
		...
		public override void SetStaticDefaults()
		{
            ...
            GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Torgue/PistolGreen/PocketRocket_FireGlow");		
		}
		...
		{
			var myClone = (PocketRocket_Fire)base.Clone(itemClone);
		...
		{	
            ...
            }        
            {
				...
				Main.projectile[proj].GetGlobalProjectile<GloriousGunsGProj>().shotFromFireWeaponCommon = true;
				for (int index1 = 0; index1 < 5; ++index1)
                {
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Torgue/PistolGreen/PocketRocket_FireGlow"),
				new Vector2
				(
