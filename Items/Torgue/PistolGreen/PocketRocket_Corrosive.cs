...
{
	public class PocketRocket_Corrosive : ModItem
	{
		public static string[] RandNames = { "Shredded","Ripped","Jacked","Hard","Stiff", "Tough", "Compressed" };
		protected ushort nameIndex;
		//protected int counter;

		public string WeaponName =>  "Juicy " + RandNames[nameIndex%RandNames.Length]+" Pocket Rocket";
		...
		public override void SetStaticDefaults()
		{
            ...
            GloriousGunsGlowmask.AddGlowMask(item.type, "GloriousGuns/Items/Torgue/PistolGreen/PocketRocket_CorrosiveGlow");		
		}
		...
		{
			var myClone = (PocketRocket_Corrosive)base.Clone(itemClone);
		...
		{	
            ...
            }        
            {
				...
				Main.projectile[proj].GetGlobalProjectile<GloriousGunsGProj>().shotFromAcidWeaponCommon = true;
				for (int index1 = 0; index1 < 5; ++index1)
                {
                    int index2 = Dust.NewDust(player.position, player.width - 60, player.height - 18, 127, 0.0f, 0.0f, (int) byte.MaxValue, new Color(), (float) GloriousGuns.instance.gloriousRNG.Next(20, 26) * 0.1f);
                    Main.dust[index2].noLight = true;
                    Main.dust[index2].noGravity = true;
                    Main.dust[index2].velocity *= 0.5f;
                    Main.dust[index2].scale *= .6f;
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float  scale, int whoAmI) 	
		{
			...
			spriteBatch.Draw
			(
				ModContent.GetTexture("GloriousGuns/Items/Torgue/PistolGreen/PocketRocket_CorrosiveGlow"),
				new Vector2
				(
